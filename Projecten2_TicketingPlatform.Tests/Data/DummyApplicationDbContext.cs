...
namespace Projecten2_TicketingPlatform.Tests.Data
{
    public class DummyApplicationDbContext
    {
        ...
        public DummyApplicationDbContext()
        {
            ...
            Contract1 = new Contract(DateTime.Today, Contract24_7, 2, "bff6a934 - 0dca - 4965 - b9fc - 91c3290792c8", ContractEnContractTypeStatus.Actief);
            Contract2 = new Contract(DateTime.Today.AddDays(400), Contract24_7, 1, "bff6a934 - 0dca - 4965 - b9fc - 91c3290792c8", ContractEnContractTypeStatus.NietActief);
