...
namespace Projecten2_TicketingPlatform.Models.Domein
{
    public class Ticket
    {
        ...
        public Ticket(string titel, int ticketId, TicketStatus ticketStatus, DateTime date, string omschrijving, int typeTicket, Klant klant, string technieker, string[] opmerkingen, string bijlage)
        {
            Titel = titel;
            Ticketid = ticketId;
            Status = ticketStatus;
